...
namespace Casino
{
    public class TwentyOneRules
    {
        ...
        {
            int ace_count = Hand.Count(x => x.Face == Face.Ace);
        ...
        {
            int[] player_results = GetAllPossibleHandValues(PlayerHand);
            int[] dealer_results = GetAllPossibleHandValues(DealerHand);
